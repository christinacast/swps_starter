<template>
  <div class="testprojekt-hinweis-page">
    ...
    <section>
      ...
      <ul>
        <li>Erlernen von Frontend- und Backend-Integration</li>
        <li>Umgang mit modernen Webtechnologien</li>
        <li>Entwicklung benutzerfreundlicher Oberflächen</li>
        <li>Arbeiten in einem kollaborativen Entwicklungsumfeld</li>
      </ul>
    </section>
